...
######  covariates, sampling covariates, taxonomy groups                     ################################
## 
## Arnaud Lyet      
## Started October 28th 2020
## Last update May 18th 2020
##
## Code for the GLM shown on Figure 4 and Supplementary Tables 2a, 2b and 2c
## 1. Packages
...
# Overwrite the list of species to remove domestic species, grouped canis, grouped small ground rodents
